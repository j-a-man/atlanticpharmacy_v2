                     ...
                     <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                <label htmlFor="booking-name" className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Full Name</label>
                                <Input 
                                    id="booking-name"
                                    required 
                            ...
                            <div className="space-y-2">
                                <label htmlFor="booking-email" className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Email Address</label>
                                <Input 
                                    id="booking-email"
                                    required 
                                    type="email" 
                            ...
                            <div className="space-y-2">
                                <label htmlFor="booking-phone" className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Phone Number</label>
                                <Input 
                                    id="booking-phone"
                                    required 
                                    type="tel" 
