        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-12">
            <div className="text-center space-y-4">
              <p className="text-xs tracking-[0.25em] text-muted-foreground">EST. SEPTEMBER 2019</p>
            ...
            <div className="space-y-8 text-center">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                Atlantic Pharmacy was founded in September 2019 with a singular vision: to provide 
                pharmaceutical care that combines clinical excellence with genuine community service. 
                We believe that modern healthcare demands both technical expertise and human connection.


              </p>
              <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                Our commitment extends beyond dispensing medications. We serve as trusted healthcare 
                partners in Brooklyn and deliver to all five boroughs of New York City, offering multilingual 
                support and offer services that address the diverse needs of our community.
