    ...
    try {
                ...
                <div class="wrapper">
                    <div class="container">
                        <div class="header">
                            ...
                            <p>Atlantic Pharmacy Contact Portal</p>
                        </div>
                        <div class="content">
                        ...
                        <div class="footer">
                            Sent from Atlantic Pharmacy Web App
                        </div>
                    </div>
                </div>
            </body>
        ...
        const userHtml = `
            ...
            <body>
                <div class="wrapper">
                    <div class="container">
                        <div class="header">
                            <h1>Atlantic Pharmacy</h1>
                        </div>
                        <div class="content">
                            <h2 class="welcome-title">Hi ${name},</h2>
                            <p>Thank you for contacting Atlantic Pharmacy! We have successfully received your inquiry and our team will get back to you shortly.</p>
                            ...
                            <div style="text-align: center; margin-top: 32px;">
                                <a href="tel:7184842260" style="display: inline-block; background-color: #0f5132; color: #ffffff !important; padding: 12px 28px; text-decoration: none; border-radius: 30px; font-weight: 600; font-size: 15px; text-align: center;">Call Pharmacy: (718) 484-2260</a>
                            </div>
                        </div>
                        <div class="footer">
                            Atlantic Pharmacy &bull; 1706B Atlantic Ave, Brooklyn, NY 11213 &bull; (718) 484-2260
                        </div>
                    </div>
                </div>
            </body>
        ...
        const mailPromises = [
            transporter.sendMail({
                from: `"Atlantic Pharmacy Web Portal" <${process.env.SMTP_USER || 'jaylinman4@gmail.com'}>`,
            ...
            transporter.sendMail({
                ...
                to: email,
                subject: '✉️ We received your message - Atlantic Pharmacy',
                html: userHtml
            })
        ];
