                ...
                <div class="wrapper">
                    <div class="container">
                        <div class="header">
                            ...
                            <p>Atlantic Pharmacy Callback Portal</p>
                        </div>
                        <div class="content">
                ...
                <div class="wrapper">
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <p>Thank you for initiating your prescription transfer to Atlantic Pharmacy. We are excited to welcome you and handle all the details for you!</p>
                            ...
                            <div style="text-align: center; margin-top: 32px;">
                                ...
                                <a href="tel:7184842260" class="btn-call" style="color: #ffffff !important; text-decoration: none;">Call Pharmacy: (718) 484-2260</a>
                            </div>
                        </div>
                        <div class="footer">
        ...
        if (email) {
            mailPromises.push(
                transporter.sendMail({
                    ...
                    to: email,
                    subject: '✅ Prescription Transfer Request Received - Atlantic Pharmacy',
                    html: patientHtml
                })
            );
        }
