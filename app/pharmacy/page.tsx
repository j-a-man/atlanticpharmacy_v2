...
const images = [
  {
    url: "/atlantic.png",
    alt: "Atlantic Pharmacy Front",
  },
  {
    url: "/image4.jpeg",
    alt: "Atlantic Pharmacy Interior",
  },
]
...
export default function PharmacyPage() {
  return (
    <main className="min-h-screen pt-20 bg-background">
      ...
      {/* Aesthetic Image Grid (2 Images) */}
      <section className="pb-24 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-[60vh] md:h-[450px]">
            {images.map((img, index) => (
              <div 
                key={index} 
                className="relative group overflow-hidden rounded-2xl border border-border/50 shadow-sm"
              >
                <img
                  src={img.url}
                  alt={img.alt}
          ...
          <div className="mt-6 flex justify-between items-end border-t border-border pt-6">
            <p className="text-xs tracking-[0.2em] text-muted-foreground">ESTABLISHED 2019</p>
            <p className="text-xs tracking-[0.2em] text-muted-foreground text-right">BROOKLYN & QUEENS</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20 space-y-6">
            ...
            <Button variant="outline" className="rounded-full border-primary/20 hover:border-primary/50" asChild>
                 <Link href="https://healthguardpharmacy.vercel.app" target="_blank">
                    View Health Guard Pharmacy Website
                 </Link>
            </Button>
          </div>
