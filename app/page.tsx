      ...
      <section className="pt-32 pb-24 px-6 lg:px-12 min-h-[90vh] flex items-center justify-center">
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="pt-12 border-t border-border max-w-3xl mx-auto">
            <p className="text-xs tracking-[0.2em] text-muted-foreground mb-8">EST. SEPTEMBER 2019</p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="space-y-2">
                <MapPin className="h-5 w-5 text-primary mx-auto" />
                <p className="text-sm tracking-[0.1em] text-foreground font-medium">Located in Brooklyn</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { title: "OMNICARDS", description: "Recharge your OmniCards and MetroCards" },
